  ...
  return (
    <group scale={scale}>
      ...
      <mesh ref={glowRef}>
        ...
        <meshBasicMaterial color={SHEEN} transparent opacity={0.02} depthWrite={false} side={THREE.BackSide} />
      </mesh>
      <mesh ref={outerRef}>
        <sphereGeometry args={[0.5, 16, 16]} />
        <meshBasicMaterial color={SHEEN} transparent opacity={0.008} depthWrite={false} side={THREE.BackSide} />
      </mesh>
      <pointLight ref={lightRef} color={SHEEN} intensity={0} distance={6} decay={2} />
    </group>
  )
}
