    ...
    <RevealBlock delay={index * 40}>
      <div
        ...
        style={{
          ...
          border: `1px solid ${hovered ? 'rgba(255,182,72,0.15)' : 'rgba(42,49,56,0.3)'}`,
          borderRadius: 6,
      ...
      >
        <span style={{
          ...
          color: hovered ? 'var(--color-spark)' : 'var(--color-slate)',
          transition: 'color 0.3s', marginTop: 2, flexShrink: 0,
        }}>
          {item.icon}
        </span>
        <div>
          <div style={{
            ...
            color: 'var(--color-bone)', marginBottom: 3,
          }}>{item.name}</div>
          <div style={{
    ...
    <div style={{ padding: '120px 48px 100px', maxWidth: 960, margin: '0 auto' }}>
      <RevealBlock>
        ...
        <p style={{
          ...
          color: 'rgba(232,234,237,0.4)', marginBottom: 64, maxWidth: 520, lineHeight: 1.7,
        }}>
      ...
      <RevealBlock delay={100}>
        <div style={{
          display: 'flex', gap: 32, marginBottom: 56, paddingBottom: 24,
          borderBottom: '1px solid rgba(42,49,56,0.3)', flexWrap: 'wrap',
        }}>
          {categories.map(cat => (
            <div key={cat.key} style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{
                fontFamily: 'var(--font-mono)', fontSize: 20, fontWeight: 600, color: 'var(--color-bone)',
              }}>{cat.count}</span>
              <span style={{
          ...
          <RevealBlock key={cat.key} delay={catIdx * 60}>
            <div style={{ marginBottom: 48 }}>
              <div style={{
                ...
                paddingBottom: 10, borderBottom: '1px solid rgba(42,49,56,0.3)',
                display: 'flex', alignItems: 'center', gap: 8,
              }}>
                <span style={{
                  width: 4, height: 4, borderRadius: '50%',
                  background: 'var(--color-sheen)', opacity: 0.5,
                }} />
                {cat.label}
                <span style={{
                  fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--color-slate)', marginLeft: 4,
                }}>{cat.count}</span>
              </div>
              <div style={{
